...
export const activityLogs: ActivityLog[] = [
  { date: '2026-05-09', event: { en: 'Thesis Defense: Outstanding Thesis', zh: '毕业答辩获评优秀论文' }, status: 'SUCCESS' },
  { date: '2025-11-20', event: { en: 'Thesis Proposal', zh: '毕业论文开题' }, status: 'PASSED' },
